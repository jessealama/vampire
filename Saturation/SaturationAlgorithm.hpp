...
protected:
  std::shared_ptr<torch::jit::script::Module> model_init;
  std::shared_ptr<torch::jit::script::Module> model_unary;
  std::shared_ptr<torch::jit::script::Module> model_binary;
  std::shared_ptr<torch::jit::script::Module> model_final;
