...
//*********************** Saturation  ***********************
    ...
    _ageWeightBlending = ChoiceOptionValue<AgeWeightBlending>("age_weight_blending","awb",
                          AgeWeightBlending::QUEUES,{"linear","loglinear","queues"});
    _ageWeightBlending.tag(OptionTag::SATURATION);
